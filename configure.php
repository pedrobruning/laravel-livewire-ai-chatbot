...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/LivewireAiChatbot.php')) => rename($file, determineSeparator('./src/'.$className.'.php')),
        str_contains($file, determineSeparator('src/LivewireAiChatbotServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/LivewireAiChatbot.php')) => rename($file, determineSeparator('./src/Facades/'.$className.'.php')),
